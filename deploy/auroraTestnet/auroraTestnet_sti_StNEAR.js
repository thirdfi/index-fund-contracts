...
module.exports = async ({ deployments }) => {
  ...
  const l2VaultArtifact = await deployments.getArtifact("BasicCompoundVaultTest");
  ...
  // Deploy the StVault
  console.log("Now deploying AuroraStNEARVaultTest...");
  const proxy = await deploy("AuroraStNEARVaultTest", {
  ...
  console.log("  AuroraStNEARVaultTest_Proxy contract address: ", proxy.address);
  const STVault = await ethers.getContractFactory("AuroraStNEARVaultTest");
...
module.exports.tags = ["auroraTestnet_sti_StNEAR"];
