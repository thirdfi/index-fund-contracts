...
module.exports = async ({ deployments }) => {
  ...
  const stVaultProxy = await ethers.getContract("AuroraStNEARVaultTest_Proxy");

  console.log("Now deploying AuroraSTIStrategyTest...");
  const proxy = await deploy("AuroraSTIStrategyTest", {
  ...
  console.log("  AuroraSTIStrategyTest_Proxy contract address: ", proxy.address);
  ...
  try {
    ...
    await run("verify:verify", {
      address: implAddress,
      contract: "contracts/sti/strategy/AuroraSTIStrategyTest.sol:AuroraSTIStrategyTest",
    });
  } catch (e) {
  }
};
module.exports.tags = ["auroraTestnet_sti_STIStrategy"];
