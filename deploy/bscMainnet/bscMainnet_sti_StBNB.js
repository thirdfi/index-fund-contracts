...
module.exports = async ({ deployments }) => {
  ...
  // Deploy the StVault
  console.log("Now deploying BscStBNBVault...");
  const proxy = await deploy("BscStBNBVault", {
  ...
  console.log("  BscStBNBVault_Proxy contract address: ", proxy.address);
  const STVault = await ethers.getContractFactory("BscStBNBVault");
  ...
  try {
    ...
    await run("verify:verify", {
      address: implAddress,
      contract: "contracts/stVaults/ankr/BscStBNBVault.sol:BscStBNBVault",
    });
  } catch (e) {
  }
  try {
...
module.exports.tags = ["bscMainnet_sti_StBNB"];
