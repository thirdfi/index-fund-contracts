...
module.exports = async ({ deployments }) => {
  ...
  console.log("Now deploying BscPriceOracle...");
  const proxy = await deploy("BscPriceOracle", {
  ...
  console.log("  BscPriceOracle_Proxy contract address: ", proxy.address);
  ...
  try {
    ...
    await run("verify:verify", {
      address: implAddress,
      contract: "contracts/bni/priceOracle/BscPriceOracle.sol:BscPriceOracle",
    });
  } catch (e) {
  }
};
module.exports.tags = ["bscMainnet_PriceOracle"];
