...
module.exports = async ({ deployments }) => {
  ...
  const stVaultProxy = await ethers.getContract("AuroraStNEARVault_Proxy");

  console.log("Now deploying AuroraSTIStrategy...");
  const proxy = await deploy("AuroraSTIStrategy", {
  ...
  console.log("  AuroraSTIStrategy_Proxy contract address: ", proxy.address);
  ...
  try {
    ...
    await run("verify:verify", {
      address: implAddress,
      contract: "contracts/sti/strategy/AuroraSTIStrategy.sol:AuroraSTIStrategy",
    });
  } catch (e) {
  }
};
module.exports.tags = ["auroraMainnet_sti_STIStrategy"];
