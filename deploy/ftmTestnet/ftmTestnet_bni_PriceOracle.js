...
module.exports = async ({ deployments }) => {
  ...
  console.log("Now deploying FtmPriceOracleTest...");
  const proxy = await deploy("FtmPriceOracleTest", {
  ...
  console.log("  FtmPriceOracleTest_Proxy contract address: ", proxy.address);
...
module.exports.tags = ["ftmTestnet_bni_PriceOracle"];
