...
const { ftmTestnet: network_ } = require("../../parameters/testnet");

module.exports = async ({ deployments }) => {
  const { deploy } = deployments;
  const [deployer] = await ethers.getSigners();

  console.log("Now deploying FtmSwapTest...");
  const proxy = await deploy("FtmSwapTest", {
  ...
  console.log("  FtmSwapTest_Proxy contract address: ", proxy.address);
...
module.exports.tags = ["ftmTestnet_Swap"];
