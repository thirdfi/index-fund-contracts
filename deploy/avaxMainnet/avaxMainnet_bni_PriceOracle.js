...
module.exports = async ({ deployments }) => {
  ...
  console.log("Now deploying AvaxPriceOracle...");
  const proxy = await deploy("AvaxPriceOracle", {
  ...
  console.log("  AvaxPriceOracle_Proxy contract address: ", proxy.address);
  ...
  try {
    ...
    await run("verify:verify", {
      address: implAddress,
      contract: "contracts/bni/priceOracle/AvaxPriceOracle.sol:AvaxPriceOracle",
    });
  } catch (e) {
  }
};
module.exports.tags = ["avaxMainnet_bni_PriceOracle"];
