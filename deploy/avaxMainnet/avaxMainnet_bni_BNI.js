...
module.exports = async ({ deployments }) => {
  ...
  console.log("Now deploying BNI...");
  const proxy = await deploy("BNI", {
  ...
  console.log("  BNI_Proxy contract address: ", proxy.address);
  ...
  try {
    ...
    await run("verify:verify", {
      address: implAddress,
      contract: "contracts/bni/BNI.sol:BNI",
    });
  } catch (e) {
  }
};
module.exports.tags = ["avaxMainnet_bni_BNI"];
