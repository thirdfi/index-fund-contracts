...
module.exports = async ({ deployments }) => {
  ...
  console.log("Now deploying STI...");
  const proxy = await deploy("STI", {
  ...
  console.log("  STI_Proxy contract address: ", proxy.address);
  ...
  try {
    ...
    await run("verify:verify", {
      address: implAddress,
      contract: "contracts/sti/STI.sol:STI",
    });
  } catch (e) {
  }
};
module.exports.tags = ["avaxMainnet_sti_STI"];
