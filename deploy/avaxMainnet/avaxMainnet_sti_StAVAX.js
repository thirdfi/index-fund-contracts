...
module.exports = async ({ deployments }) => {
  ...
  // Deploy the StVault
  console.log("Now deploying AvaxStAVAXVault...");
  const proxy = await deploy("AvaxStAVAXVault", {
  ...
  console.log("  AvaxStAVAXVault_Proxy contract address: ", proxy.address);
  const STVault = await ethers.getContractFactory("AvaxStAVAXVault");
  ...
  try {
    ...
    await run("verify:verify", {
      address: implAddress,
      contract: "contracts/stVaults/ankr/AvaxStAVAXVault.sol:AvaxStAVAXVault",
    });
  } catch (e) {
  }
  try {
...
module.exports.tags = ["avaxMainnet_sti_StAVAX"];
