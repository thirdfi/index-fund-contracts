...
module.exports = async ({ deployments }) => {
  ...
  const strategyProxy = await ethers.getContract("BscSTIStrategyTest_Proxy");
  const STIStrategy = await ethers.getContractFactory("BscSTIStrategyTest");
...
module.exports.tags = ["bscTestnet_sti_STIVault"];
