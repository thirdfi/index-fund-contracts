...
module.exports = async ({ deployments }) => {
  ...
  // Deploy the StVault
  console.log("Now deploying AvaxStAVAXVaultTest...");
  const proxy = await deploy("AvaxStAVAXVaultTest", {
  ...
  console.log("  AvaxStAVAXVaultTest_Proxy contract address: ", proxy.address);
  const STVault = await ethers.getContractFactory("AvaxStAVAXVaultTest");
  ...
  const dataStVaultNft = nftIface.encodeFunctionData("initialize", [
    "STI Staking AVAX NFT", "stiStAVAXNft",
    stVault.address,
  ]);
  ...
  try {
    ...
    await run("verify:verify", {
      address: implAddress,
      contract: "contracts/stVaults/ankr/AvaxStAVAXVaultTest.sol:AvaxStAVAXVaultTest",
    });
  } catch (e) {
  }
  try {
...
module.exports.tags = ["avaxTestnet_sti_StAVAX"];
