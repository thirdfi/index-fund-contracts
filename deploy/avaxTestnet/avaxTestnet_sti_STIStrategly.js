...
module.exports = async ({ deployments }) => {
  ...
  const stVaultProxy = await ethers.getContract("AvaxStAVAXVaultTest_Proxy");

  console.log("Now deploying AvaxSTIStrategyTest...");
  const proxy = await deploy("AvaxSTIStrategyTest", {
  ...
  console.log("  AvaxSTIStrategyTest_Proxy contract address: ", proxy.address);
...
module.exports.tags = ["avaxTestnet_sti_STIStrategy"];
