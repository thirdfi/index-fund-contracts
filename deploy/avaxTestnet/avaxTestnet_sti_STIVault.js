...
module.exports = async ({ deployments }) => {
  ...
  const strategyProxy = await ethers.getContract("AvaxSTIStrategyTest_Proxy");
  const STIStrategy = await ethers.getContractFactory("AvaxSTIStrategyTest");
...
module.exports.tags = ["avaxTestnet_sti_STIVault"];
