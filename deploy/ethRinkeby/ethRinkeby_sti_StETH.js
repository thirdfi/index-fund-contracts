...
module.exports = async ({ deployments }) => {
  ...
  // Deploy the StVault
  console.log("Now deploying EthStETHVaultTest...");
  const proxy = await deploy("EthStETHVaultTest", {
  ...
  console.log("  EthStETHVaultTest_Proxy contract address: ", proxy.address);
  const STVault = await ethers.getContractFactory("EthStETHVaultTest");
...
module.exports.tags = ["ethRinkeby_sti_StETH"];
