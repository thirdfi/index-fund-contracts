...
module.exports = async ({ deployments }) => {
  ...
  const strategyProxy = await ethers.getContract("EthSTIStrategyTest_Proxy");
  const STIStrategy = await ethers.getContractFactory("EthSTIStrategyTest");
...
module.exports.tags = ["ethRinkeby_sti_STIVault"];
